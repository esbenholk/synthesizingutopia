  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "user",
          content: `pretend that you are an image prompt engineer. We need to make an image depicts following sentence: There is... ${prompt}, it should fit this vibe: ${adjectives}, please output an image prompt`,
        },
      ],
      max_tokens: 100,
    });
